...
class PropertyController extends GetxController {
  ...
  RxList<PropertyCategoryModel> propertyCategoryList =
      <PropertyCategoryModel>[].obs;
  ...
  void fetchAllPropertyCategories() async {
    try {
      final response =
          await AppConfig().supaBaseClient.from('property_categories').select();
  ...
  void fetchAllPropertyTypes() async {
    try {
      final response =
          await AppConfig().supaBaseClient.from('property_types').select();
      final data = response as List<dynamic>;
      print(response);
      print(response.length);
      print(data.length);
