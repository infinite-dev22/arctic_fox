...
class FloorListModel {
  ...
  factory FloorListModel.fromJson(Map<String, dynamic> json) => FloorListModel(
    floorsonproperty: json["floorsonproperty"] == null ? [] : List<FloorModel>.from(json["floorsonproperty"]!.map((x) => FloorModel.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "floorsonproperty": floorsonproperty == null ? [] : List<dynamic>.from(floorsonproperty!.map((x) => x.toJson())),
  };
}
