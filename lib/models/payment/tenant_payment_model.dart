...
TenantPaymentModel tenantPaymentModelFromJson(String str) =>
    TenantPaymentModel.fromJson(json.decode(str));

String tenantPaymentModelToJson(TenantPaymentModel data) =>
...
class TenantPaymentModel {
  ...
  factory TenantPaymentModel.fromJson(Map<String, dynamic> json) =>
      TenantPaymentModel(
        ...
        unitModel:
            json["units"] == null ? null : UnitModel.fromJson(json["units"]),
      );
