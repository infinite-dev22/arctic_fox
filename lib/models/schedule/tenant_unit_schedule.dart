...
List<TenantUnitScheduleModel> tenantUnitScheduleModelFromJson(String str) => List<TenantUnitScheduleModel>.from(json.decode(str).map((x) => TenantUnitScheduleModel.fromJson(x)));

String tenantUnitScheduleModelToJson(List<TenantUnitScheduleModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class TenantUnitScheduleModel extends SmartTenantUnitScheduleModel {
  ...
  factory TenantUnitScheduleModel.fromJson(Map<String, dynamic> json) => TenantUnitScheduleModel(
    id: json["id"],
    amount: json["amount"],
