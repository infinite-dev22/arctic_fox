...
import 'package:smart_rent/models/tenant/tenant_profile_model.dart';import 'package:smart_rent/models/tenant/tenant_type_model.dart';
...
class TenantModel extends SmartTenantModel {
  ...
  factory TenantModel.fromJson(Map<String, dynamic> json) => TenantModel(
        ...
        businessTypes: json["business_types"] == null
            ? null
            : BusinessTypeModel.fromJson(json["business_types"]),
        tenantTypes: json["tenant_types"] == null
            ? null
            : TenantTypeModel.fromJson(json["tenant_types"]),
        nationalities: json["currency_symbol"] == null
            ? null
            : NationalityModel.fromJson(json["currency_symbol"]),
        tenantProfiles: json["tenant_profiles"] == null
            ? []
            : List<TenantProfileModel>.from(json["tenant_profiles"]!
                .map((x) => TenantProfileModel.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "tenant_profiles": tenantProfiles == null
            ? []
  ...
  String getImageDocUrl() {
    return documents!.fileUrl.toString();
  }

  @override
  String getBusinessType() {
    return businessTypes!.name.toString();
  }

  @override
  String getTenantType() {
    return tenantTypes!.name.toString();
  }
}
