...
class EmployeeCardWidget extends StatelessWidget {
  ...
  const EmployeeCardWidget({super.key, required this.index, required this.editFunction, required this.employeeModel, required this.deleteFunction});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text('${employeeModel.employee!.firstName} ${employeeModel.employee!.lastName}',
            ...
            Text('${employeeModel.employee!.firstName} ${employeeModel.employee!.lastName}', style: AppTheme.darkBlueTitle,),
            Bounceable(
                onTap: (){
