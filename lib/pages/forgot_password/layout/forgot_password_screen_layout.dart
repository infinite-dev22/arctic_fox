...
class ForgotPasswordScreenLayout extends StatefulWidget {
  ...
  @override
  State<ForgotPasswordScreenLayout> createState() =>
      _ForgotPasswordScreenLayoutState();
}

class _ForgotPasswordScreenLayoutState
    extends State<ForgotPasswordScreenLayout> {
      ...
      listener: (context, state) {
        if (state.status == ForgotPasswordStatus.success) {
          Fluttertoast.showToast(
              msg:
                  'Reset Link Sent to ${emailEditingController.text.toString()}',
