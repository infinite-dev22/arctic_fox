      ...
      listener: (context, state) {
        if (state.status == HomeStatus.successLogout) {
          Fluttertoast.showToast(
              msg: state.message.toString(), backgroundColor: Colors.green,
              gravity: ToastGravity.TOP
          );
          Get.off(() => InitialScreen());
        }
        if (state.status == HomeStatus.accessDenied) {
                ...
                builder: (context, state) {
                  return PopupMenuButton(
                    icon: Padding(
                      ...
                      child: Image.asset(
                        'assets/home/sidely.png', color: Colors.white,),
                    ),
                    onSelected: (value) async {
                      if (value == 1) {
                        context.read<HomeBloc>().add(LogoutUserEvent(
                            userStorage.read('accessToken')));
                      }
                    },
                    itemBuilder: (context) {
                      return [
                      ...
                      BlocBuilder<PropertyBloc, PropertyState>(
                        builder: (context, state) {
                          ...
                          return HomeCardWidget1(
                            ...
                            total: state.properties == null ? 0 : state
                                .properties!.length,
                      ...
                      BlocBuilder<TenantBloc, TenantState>(
                        builder: (context, state) {
                          ...
                          return HomeCardWidget1(
                            ...
                            total: state.tenants == null ? 0 : state
                                .tenants!.length,
                            title: 'Total Tenants',
                            function: () {
                            ...
                            Padding(
                              ...
                              child: SingleChildScrollView(
                                child: Form(
                                  ...
                                  child: Column(
                                    children: [
                                      CustomApiTenantTypeDropdown(
                                        hintText: 'Select Tenant Type',
                                        menuItems: <SmartTenantTypeModel>[],
                                        onChanged: (value) {
