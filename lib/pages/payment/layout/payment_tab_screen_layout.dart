...
class PaymentTabScreenLayout extends StatefulWidget {
  ...
  const PaymentTabScreenLayout(
      {super.key, required this.propertyDetailsOptionsController, required this.unitController, required this.id});
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                                  ...
                                  return SearchableSpecificTenantUnitDropDown<
                                    ...
                                    onChanged: (value) {
                                      ...
                                      tenantController
                                          ...
                                          .then((value) {
                                        amountController.text =amountFormatter.format(tenantController.totalScheduleBalance
                                            .toString());
                                        balanceController.text = amountFormatter.format(tenantController.totalScheduleBalance
                                            .toString());
                                      ...
                                      // amountController.text = value.value.amount.toString();
                                      // discountController.text = value.value.amount.toString();
                                      print('MY Unit is ${tenantController.unitId
                                          .value}');
                                      print('MY Amount is ${tenantController
                                          .unitAmount.value}');
                                    },
                                  );
                                }),
                              ...
                              Row(
                                ...
                                children: [
                                  SizedBox(
                                      child: CustomGenericDropdown(hintText: 'Payment Mode', menuItems: []),
                                    width: 40.w,
                                  ),
                                  SizedBox(
                                      width: 40.w,
                                      child: CustomGenericDropdown(hintText: 'Credited Account', menuItems: [])),
                                ],
                              ),
                                    ...
                                    SizedBox(
                                      child: AuthTextField(
                                        ...
                                        onChanged: (value) {
                                          ...
                                          balanceController.text = (int.parse(amountController.text.trim().toString().replaceAll(',', '')) - int.parse(paidController.text.isEmpty ? '0' : paidController.text.trim().replaceAll(',', ''))).toString().replaceAll(',', '');
                                ...
                                Bounceable(
                                    ...
                                    FullPicker(
                                      ...
                                      onSelected: (value) async {
                                        ...
                                        setState(() {
                                          ...
                                          paymentImageExtension = value.file.first!
                                              .path
                                              .split('.')
                                              .last;
                                          paymentFileName = value.file.first!
                                              .path
                                              .split('/')
                                              .last;
                                        });
                                        paymentBytes = await paymentPic!.readAsBytes();
                                  ...
                                  child: Container(
                                    ...
                                    child: paymentPic == null ? Center(
                                      child: Text('Upload payment pic'),) : null,
                                  ),
                                ),
