                          ...
                          children: [
                            ...
                            Obx(() {
                              return SearchableUnitDropDown<UnitModel>(
                                hintText: 'Unit',
                                menuItems:
                                    tenantController.specificUnitList.value,
                                controller: _unitCont,
                                onChanged: (value) {
                                  print(value.value.id);
                                  tenantController
          ...
          children: [
            ...
            Obx(() {
              var groupedData = tenantController.groupAllPropertyTenants(
                  tenantController.propertyTenantList.value,
                                  ...
                                  child: ListTile(
                                    leading: ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          width: 20.w,
                                          imageUrl: entry.tenantModel!
                                              .getImageDocUrl(),
                                          fit: BoxFit.cover,
                                        )),
                                    title: Text(
                                      entry.tenantModel!.name.toString(),
                                      style: AppTheme.appTitle3,
                                    ),
                                    subtitle: Text(
                                      '${entry.tenantModel!.tenantTypes!.name}',
