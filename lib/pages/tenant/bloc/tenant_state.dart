...
enum TenantStatus { initial, success, loading, accessDenied, error, empty,
  loadingDetails, successDetails, errorDetails, emptyDetails, successTT, loadingTT,
  accessDeniedTT, errorTT, emptyTT
}
...
@immutable
 class TenantState extends Equatable {
  ...
  List<Object?> get props => [tenants, status, tenantModel, isLoading, tenantTypes];
}
