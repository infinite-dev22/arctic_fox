      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            tenantModel.tenantType!.name == 'Individual'
                ? Container()
            ...
            tenantModel.tenantType!.id == 1
                ? DetailsRowWidget(
                    title: 'Email',
                    trailing:
                        tenantModel.tenantProfiles!.first.email.toString(),
                  )
                : Container(),
            tenantModel.tenantType!.id == 1
                ? DetailsRowWidget(
                    title: 'DOB',
                    trailing: DateFormat('EEE - MMM d - yyy').format(
                        DateTime.parse(tenantModel
                            .tenantProfiles!.first.dateOfBirth
                            .toString())))
                : Container(),
            tenantModel.tenantType!.id == 1
                ? DetailsRowWidget(
            ...
            tenantModel.tenantType!.id == 1
                ? DetailsRowWidget(
                    title: 'Gender',
                    trailing:
                        tenantModel.tenantProfiles!.first.gender.toString(),
                  )
                : Container(),
            tenantModel.tenantType!.id == 1
                ? DetailsRowWidget(
                    title: 'Contact',
                    trailing:
                        tenantModel.tenantProfiles!.first.number.toString(),
                  )
                : Container(),
            tenantModel.tenantType!.id == 1
                ? DetailsRowWidget(
                ...
                ? Column(
                    children: [
                      ...
                      DetailsRowWidget(
                        title: 'Email',
                        trailing:
                            tenantModel.tenantProfiles!.first.email == null
                                ? ''
                                : tenantModel.tenantProfiles!.first.email
                                    .toString(),
                      ),
                      DetailsRowWidget(
                          title: 'DOB',
                          trailing:
                              tenantModel.tenantProfiles!.first.dateOfBirth ==
                                      null
                                  ? ''
                                  : DateFormat('EEE - MMM d - yyy').format(
                                      DateTime.parse(tenantModel
                                          .tenantProfiles!.first.dateOfBirth
                                          .toString()))),
                      DetailsRowWidget(
                        title: 'NIN',
                        trailing: tenantModel.tenantProfiles!.first.nin == null
                            ? ''
                            : tenantModel.tenantProfiles!.first.nin.toString(),
                      ),
                      DetailsRowWidget(
                        title: 'Gender',
                        trailing:
                            tenantModel.tenantProfiles!.first.gender == null
                                ? ''
                                : tenantModel.tenantProfiles!.first.gender
                                    .toString(),
                      ),
                      DetailsRowWidget(
                        title: 'Contact',
                        trailing:
                            tenantModel.tenantProfiles!.first.number == null
                                ? ''
                                : tenantModel.tenantProfiles!.first.number
                                    .toString(),
                      ),
                    ],
                  )
