            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    userStorage.read('organisationName').toString(),
              ...
              Obx(() {
                return AppSearchTextField(
                  ...
                  number:
                      widget.tenantController.propertyModelList.value.length,
                );
              }),
              Obx(() {
                return widget.tenantController.isPropertyModelListLoading.value
                    ...
                    : ListView.builder(
                        ...
                        itemCount:
                            widget.tenantController.propertyModelList.length,
                        clipBehavior: Clip.none,
                        itemBuilder: (context, index) {
                          var property =
                              widget.tenantController.propertyModelList[index];
