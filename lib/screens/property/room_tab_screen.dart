                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                            ...
                            SizedBox(
                              ...
                              child: Obx(() {
                                return CustomApiGenericDropdown<UnitTypeModel>(
                                  hintText: 'Unit Type',
                                  menuItems:
                                      widget.unitController.unitTypeList.value,
                                  onChanged: (value) {
                                    widget.unitController
                                        .setUnitTypeId(value!.id);
                                  },
                                );
                              }),
                            ),
                            SizedBox(
                              ...
                              child: Obx(() {
                                return CustomApiGenericDropdown<FloorModel>(
                                  hintText: 'Level',
                                  menuItems:
                                      widget.unitController.floorList.value,
                                  onChanged: (value) {
                                    widget.unitController
                                        .setFloorId(value!.id!);
                                  },
                        ...
                        Obx(() {
                          return CustomApiCurrencyDropdown<CurrencyModel>(
                            hintText: 'Currency',
              ...
              Obx(() {
                return widget.unitController.isUnitLoading.value
                    ? Padding(
                        ...
                        child: Center(
                          child:
                              Image.asset('assets/auth/logo.png', width: 35.w),
                        ),
                      )
                    : Expanded(
                        child: ListView.builder(
                            physics: NeverScrollableScrollPhysics(),
                            itemCount: widget.unitController.roomList.length,
                            shrinkWrap: true,
                            itemBuilder: (context, index) {
                              var roomModel =
                                  widget.unitController.roomList[index];
                              return RoomOptionWidget(
                                roomModel: roomModel,
                                index: index,
