                  ...
                  (state) {
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          var tenant =
                              widget.tenantController.tenantList[index];
                          return Padding(
                            ...
                            child: SlideInUp(
                              ...
                              child: TenantCardWidget(
                                ...
                                editFunction: () {
                                  if (tenant.tenantTypeId == 2) {
                                    Get.to(() =>
                                        UpdateCompanyTenantWithContactScreen(
                                            tenantModel: tenant));
                                  } else {
                                    Get.to(() => UpdateIndividualTenantScreen(
                                        tenantModel: tenant));
                                  }
                                },
                              ),
                          ...
                          : Bounceable(
                              onTap: () async {
                                if (widget
                                  ...
                                  if (widget.tenantController.tenantTypeId
                                          .value ==
                                      1) {
                                    if (_formKey.currentState!.validate() &&
                                        _individualFormKey.currentState!
                                            .validate()) {
                                      // Get.snackbar(
                                    ...
                                    if (widget.tenantController
                                        .isAddContactPerson.isFalse) {
                                      if (_formKey.currentState!.validate() &&
                                          _companyFormKey.currentState!
                                              .validate()) {
                                        // Get.snackbar(
                            ...
                            children: [
                              Obx(() {
                                return CustomApiTenantTypeDropdown(
                                  ...
                                  menuItems: widget
                                      .tenantController.tenantTypeList.value,
                                  onChanged: (value) {
                                    widget.tenantController
                              ...
                              Obx(() {
                                return widget.tenantController.tenantTypeId
                                            .value ==
                                        0
                                    ? Container()
                                    : CustomApiGenericDropdown<
                                        ...
                                        onChanged: (value) {
                                          ...
                                          print(
                                              'MY Business == ${widget.tenantController.businessTypeId.value}');
                                        },
                                      );
                              }),
