  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Obx(() {
        ...
        return tenantController.isPaymentScheduleLoading.value
            ? Padding(
            ...
            : tenantController.propertyUnitScheduleList.value.isEmpty
                ? Center(
                    child:
                        Text('No Units Attached', style: AppTheme.blueSubText))
                : Wrap(
                    alignment: WrapAlignment.center,
                    children: groupedData.keys
                        .toList()
                        .map((unitId) => Bounceable(
                              onTap: () {
                                Get.to(() => SpecificPaymentScheduleScreen(
