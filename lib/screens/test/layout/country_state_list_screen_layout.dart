...
class CountryCityListScreenLayout extends StatefulWidget {
  ...
  @override
  State<CountryCityListScreenLayout> createState() =>
      _CountryCityListScreenLayoutState();
}

class _CountryCityListScreenLayoutState
    extends State<CountryCityListScreenLayout> {
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: state.cities!
                            .map((city) => DropdownMenuItem<String>(
                                value: city.toString(), child: Text(city)))
                            .toList(),
                        // items: state.cities!
