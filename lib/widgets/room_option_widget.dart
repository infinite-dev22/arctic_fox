                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: CustomGenericDropdown<String>(
                                hintText: 'Level',
                                menuItems: widget
                                    .propertyDetailsOptionsController.levelList,
                                onChanged: (value) {},
                              ),
                            ),
                          ],
    ...
    return Card(
      child: ListTile(
        ...
        title: Row(
          ...
          children: [
            Text(
              '${widget.roomModel.name}${widget.roomModel.unitNumber}',
            ...
            Text(
                '${amountFormatter.format(widget.roomModel.amount.toString())}/=',
        ...
        subtitle: Row(
          ...
          children: [
            Text(
              '${widget.roomModel.floorModel!.name}',
              style: AppTheme.subText,
            ),
            Bounceable(
              onTap: () async {
                if (widget.roomModel.isAvailable == false) {
                  Get.defaultDialog(
                      ...
                      middleText:
                          'Make Room ${widget.roomModel.unitNumber} available',
                        ...
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: Obx(() {
                                return AppButton(
                                    title: 'Yes',
                                    isLoading: widget.unitController!
                                        .isUpdateStatusLoading.value,
                                    color: AppTheme.primaryColor,
                                    function: () async {
                                      await widget.unitController!
                                          .updateUnitStatusAvailable(
                                              widget.roomModel,
                                              widget.roomModel.propertyId!);
                                    });
                              })),
                        ],
                      ),
              ...
              child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      widget.roomModel.isAvailable == true
                          ? 'available'
                          : 'occupied',
                      style: TextStyle(
